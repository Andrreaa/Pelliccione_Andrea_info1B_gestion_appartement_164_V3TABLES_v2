"""
    Fichier : gestion_appartement_wtf_forms.py
...
class FormWTFAjouterGenres(FlaskForm):
    """
        Dans le formulaire "appartement_ajouter_wtf.html" on impose que le champ soit rempli.
...
class FormWTFUpdateGenre(FlaskForm):
    """
        Dans le formulaire "appartement_update_wtf.html" on impose que le champ soit rempli.
        Définition d'un "bouton" submit avec un libellé personnalisé.
    """
...
class FormWTFDeleteGenre(FlaskForm):
    """
        Dans le formulaire "appartement_delete_wtf.html"
