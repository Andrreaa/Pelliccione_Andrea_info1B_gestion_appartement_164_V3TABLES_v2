...
from APP_FILMS_164.appartement.gestion_appartement_wtf_forms import FormWTFAjouterGenres
from APP_FILMS_164.appartement.gestion_appartement_wtf_forms import FormWTFDeleteGenre
from APP_FILMS_164.appartement.gestion_appartement_wtf_forms import FormWTFUpdateGenre
        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_appart_sel == 0:
                    ...
                    strsql_appartement_afficher = """SELECT Id_appartement, nom_appartement, pays, npa, ville, rue FROM t_appartement ORDER BY Id_appartement DESC"""
            ...
            raise ExceptionGenresAfficher(f"fichier : {Path(__file__).name}  ;  "
                                          f"{appartement_afficher.__name__} ; "
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_genre = """INSERT INTO t_appartement (Id_appartement,nom_appartement,pays,npa,ville,rue) VALUES (NULL,%(value_nom_appartement)s,%(value_pays)s,%(value_npa)s,%(value_ville)s,%(value_rue)s) """
    ...
    try:
        ...
        if request.method == "GET":
            ...
            with DBconnection() as mydb_conn:
                ...
                # Opération sur la BD pour récupérer "Id_personne" et "Nom_personne" de la "t_personne"
                str_sql_id_genre = "SELECT Id_appartement, nom_appartement, pays, npa, ville, rue FROM t_appartement WHERE Id_appartement = %(value_id_genre)s"
