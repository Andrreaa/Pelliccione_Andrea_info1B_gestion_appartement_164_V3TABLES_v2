...
def demo_select_wtf():
    ...
    # Objet formulaire pour montrer une liste déroulante basé sur la table "t_personne"
    ...
    try:
        ...
        if request.method == "GET":
            with DBconnection() as mc_afficher:
                strsql_droit_afficher = """SELECT Id_personne, Nom_personne FROM t_personne ORDER BY Id_personne ASC"""
            ...
            # genre_val_list_dropdown = [(i["Id_personne"], i["Nom_personne"]) for i in data_genres]
